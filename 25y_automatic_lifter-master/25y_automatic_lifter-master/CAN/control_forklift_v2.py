# -*- coding: utf-8 -*-
# =============================================================================
# ⚠ DEPRECATED (참고용 v2 텔레옵) — 자율주행 코드는 depth_cam/calib/can/ 사용.
#   주의: 이 파일의 lift_up(0x15)/lift_down(0x25) 은 v1/forklift_ctrl 과 반대.
#   어느 쪽이 실차에 맞는지 벤치 확인 전까지 이 값을 근거로 쓰지 말 것.
