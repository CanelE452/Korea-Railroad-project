...
_C.MODEL.SMOKE_HEAD.REGRESSION_LOSS = "L1"
_C.MODEL.SMOKE_HEAD.SMOOTH_L1_BETA = 1.0
...
_C.DISTILL.HM_WEIGHT = 1.0
_C.DISTILL.REG_WEIGHT = 2.0
_C.DISTILL.GT_WEIGHT = 1.0
